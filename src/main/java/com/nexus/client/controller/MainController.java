...
public class MainController implements Initializable {
    ...
    private void loadLibraryView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/nexus/client/views/LibraryView.fxml"));
    ...
    private void handleMinimize(ActionEvent event) {
        NexusLauncherApp.minimizeWithAnimation();
    }

    @FXML
    private void handleMaximize(ActionEvent event) {
        NexusLauncherApp.toggleMaximizeWithAnimation();
    }

    @FXML
    private void handleClose(ActionEvent event) {
        NexusLauncherApp.closeWithAnimation();
    }
    ...
    private void onNavScan() {
        ...
        loadView("/com/nexus/client/views/ScanView.fxml");
    }
    ...
    private void onNavFavorites() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/nexus/client/views/FavoritesView.fxml"));
    ...
    private void onNavSettings() {
        ...
        loadView("/com/nexus/client/views/SettingsView.fxml");
    }
    ...
    public void showGameDetails(Game game) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/nexus/client/views/GameDetailsView.fxml"));
            Node view = loader.load();
