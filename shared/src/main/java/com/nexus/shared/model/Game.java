...
public class Game implements Serializable {
    ...
    /** Installation path / folder containing the game */
    ...
    /** Unique identifier to prevent duplicates (e.g., "steam_123456", "epic_fortnite") */
    @Column(name = "unique_id", unique = true)
    private String uniqueId;

    /** Icon path for system games */
    ...
    /**
     * Creates a unique ID based on platform and identifier
     */
